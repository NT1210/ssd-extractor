...
function sortout_crab(list){
    ...
    for (i=0; i<cnt_of_list; i++){
        ...
        if ( (product_to_be_searched.includes('стр') && product_to_be_searched.includes('оп')) || product_to_be_searched.includes("опилио") ){
...
function sortType(matched_list){
    ...
    matched_list.forEach(obj => {
        ...
        }else if(obj.product.includes("вар") || check !== null){
