...
const CrabOPSSD = ({setSsdCheck, setPage, ssdCheck}) => {
    ...
    <>
        ...
        >
          ...
          <br /><br />
           ...
           {ssdCheck? (
            <Button rounded="full" variant="solid" colorScheme='blue' onClick={()=> setPage("CrabOPDousei")}>動静ファイル選択へ</Button>
           ) : ""} 
