...
const CrabOPDousei = ({setDouseiCheck, setPage, douseiCheck}) => {
    ...
    <>
        ...
        >
          ...
          {/* <Button rounded="full" variant="solid" colorScheme='blue' onClick={()=> setPage("Cod")}>前へ</Button> */}
           {douseiCheck? (
            <Button rounded="full" variant="solid" colorScheme='blue' onClick={()=> setPage("CrabOPDB")}>生産者DB選択へ</Button>
           ) : ""} 
