...
const CodDousei = ({setDouseiCheck, setPage, douseiCheck}) => {
    ...
    <>
        ...
        >
          ...
          {/* <Button rounded="full" variant="solid" colorScheme='blue' onClick={()=> setPage("Cod")}>前へ</Button> */}
           {douseiCheck? (
            <Button rounded="full" variant="solid" colorScheme='blue' onClick={()=> setPage("CodPreExecute")}>最終確認へ</Button>
           ) : ""} 
