...
const CrabSSD = ({setSsdCheck, setPage, ssdCheck}) => {
    ...
    <>
        ...
        >
          ...
          <br /><br />
           ...
           {ssdCheck? (
            <Button rounded="full" variant="solid" colorScheme='blue' onClick={()=> setPage("CrabDousei")}>動静ファイル選択へ</Button>
           ) : ""} 
